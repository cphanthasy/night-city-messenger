...
export class CyberTimePicker {
  ...
  get _S() {
    return {
      root:        'font-family:Rajdhani,sans-serif; color:#e0e0e8; user-select:none;',
      presetRow:   'display:flex; gap:4px; padding:0 0 10px; border-bottom:1px solid #1a1a2e; margin-bottom:10px;',
      preset:      'display:inline-flex; align-items:center; gap:4px; font-family:Rajdhani,sans-serif; font-size:11px; font-weight:600; color:#8888a0; background:rgba(136,136,160,0.06); border:1px solid rgba(136,136,160,0.15); border-radius:3px; padding:3px 8px; cursor:pointer; transition:all 0.15s; white-space:nowrap;',
      ...
      input:       'font-family:Share Tech Mono,monospace; font-size:16px; color:#e0e0e8; background:#12121a; border:1px solid #2a2a45; border-radius:3px; padding:6px 4px; text-align:center; width:100%; outline:none; transition:border-color 0.15s;',
      inputYear:   'width:72px;',
      inputMD:     'width:48px;',
      inputHM:     'width:48px;',
      sep:         'font-family:Share Tech Mono,monospace; font-size:16px; color:#444460; padding:0 1px; margin-top:10px;',
      timeRow:     'display:flex; align-items:center; gap:4px; margin-bottom:16px;',
      colon:       'font-family:Share Tech Mono,monospace; font-size:20px; font-weight:700; color:#19f3f7; margin-top:10px;',
      ...
      preview:     'background:#08080e; border:1px solid #1e1e30; border-radius:4px; padding:10px 14px; position:relative; overflow:hidden;',
      previewLbl:  'font-size:8px; font-weight:600; color:#444460; text-transform:uppercase; letter-spacing:0.1em; margin-bottom:6px;',
      previewDate: 'font-family:Share Tech Mono,monospace; font-size:22px; font-weight:400; color:#19f3f7; letter-spacing:0.03em; text-shadow:0 0 12px rgba(25,243,247,0.25); line-height:1; margin-bottom:4px;',
